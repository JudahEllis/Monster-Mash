...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    private List<IStartingActionMapActions> m_StartingActionMapActionsCallbackInterfaces = new List<IStartingActionMapActions>();
    ...
    public struct StartingActionMapActions
    {
        ...
        public void AddCallbacks(IStartingActionMapActions instance)
        {
            if (instance == null || m_Wrapper.m_StartingActionMapActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_StartingActionMapActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IStartingActionMapActions instance)
        {
            @EnterGameControllerMap.started -= instance.OnEnterGameControllerMap;
            @EnterGameControllerMap.performed -= instance.OnEnterGameControllerMap;
            @EnterGameControllerMap.canceled -= instance.OnEnterGameControllerMap;
        ...
        public void RemoveCallbacks(IStartingActionMapActions instance)
        {
            if (m_Wrapper.m_StartingActionMapActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IStartingActionMapActions instance)
        {
            foreach (var item in m_Wrapper.m_StartingActionMapActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_StartingActionMapActionsCallbackInterfaces.Clear();
    ...
    private List<IUINavagationActions> m_UINavagationActionsCallbackInterfaces = new List<IUINavagationActions>();
    ...
    public struct UINavagationActions
    {
        ...
        public void AddCallbacks(IUINavagationActions instance)
        {
            if (instance == null || m_Wrapper.m_UINavagationActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_UINavagationActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IUINavagationActions instance)
        {
            @MoveCursorGenericGamepad.started -= instance.OnMoveCursorGenericGamepad;
            @MoveCursorGenericGamepad.performed -= instance.OnMoveCursorGenericGamepad;
            @MoveCursorGenericGamepad.canceled -= instance.OnMoveCursorGenericGamepad;
        ...
        public void RemoveCallbacks(IUINavagationActions instance)
        {
            if (m_Wrapper.m_UINavagationActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IUINavagationActions instance)
        {
            foreach (var item in m_Wrapper.m_UINavagationActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_UINavagationActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<IBuildAScareDirectControlActions> m_BuildAScareDirectControlActionsCallbackInterfaces = new List<IBuildAScareDirectControlActions>();
    ...
    public struct BuildAScareDirectControlActions
    {
        ...
        public void AddCallbacks(IBuildAScareDirectControlActions instance)
        {
            if (instance == null || m_Wrapper.m_BuildAScareDirectControlActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_BuildAScareDirectControlActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IBuildAScareDirectControlActions instance)
        {
            @PartLocomotion.started -= instance.OnPartLocomotion;
            @PartLocomotion.performed -= instance.OnPartLocomotion;
            @PartLocomotion.canceled -= instance.OnPartLocomotion;
        ...
        public void RemoveCallbacks(IBuildAScareDirectControlActions instance)
        {
            if (m_Wrapper.m_BuildAScareDirectControlActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IBuildAScareDirectControlActions instance)
        {
            foreach (var item in m_Wrapper.m_BuildAScareDirectControlActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_BuildAScareDirectControlActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<IBuildAScareDragAndDropActions> m_BuildAScareDragAndDropActionsCallbackInterfaces = new List<IBuildAScareDragAndDropActions>();
    ...
    public struct BuildAScareDragAndDropActions
    {
        ...
        public void AddCallbacks(IBuildAScareDragAndDropActions instance)
        {
            if (instance == null || m_Wrapper.m_BuildAScareDragAndDropActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_BuildAScareDragAndDropActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IBuildAScareDragAndDropActions instance)
        {
            @CursorMovement.started -= instance.OnCursorMovement;
            @CursorMovement.performed -= instance.OnCursorMovement;
            @CursorMovement.canceled -= instance.OnCursorMovement;
        ...
        public void RemoveCallbacks(IBuildAScareDragAndDropActions instance)
        {
            if (m_Wrapper.m_BuildAScareDragAndDropActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IBuildAScareDragAndDropActions instance)
        {
            foreach (var item in m_Wrapper.m_BuildAScareDragAndDropActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_BuildAScareDragAndDropActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
