...
public class judah_input_handler : MonoBehaviour
{
    [SerializeField]
    ...
    private void Awake()
    {
        ...
        judah_game_manager gameManager = GameObject.Find("Game Manager").GetComponent<judah_game_manager>();
...
[System.Serializable]
public class judahavailableControllerInputs
{
